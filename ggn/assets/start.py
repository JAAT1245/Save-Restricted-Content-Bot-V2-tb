...
async def term_command(event):
    ...
    buttons = [
        [Button.url("Query?", url="https://t.me/Free_course2_bot"),
         Button.url("Channel", url="https://t.me/TARGETALLCOURSE")]
    ]
...
async def youtube_dl_command(_, message):
    ...
    if len(message.command) > 1:
        ...
        try:
            ...
            caption = f"{video_info['title']}\n\n__**Powered by [Advance Content  Bot](https://t.me/Free_course2_bot)**__"  # Set caption to the title of the video
